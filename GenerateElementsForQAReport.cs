...
{
    public class GenerateElementsForQAReport : CodeActivity
    {
        /// <summary>
        /// Workflow input
        /// </summary>
        ...
        protected override void Execute(CodeActivityContext activityContext)
        {
            ...
            if (this.Arg_WO != null)
            {
                ...
                //call the Create service task function.
                CreateServiceTaskFromDatabase(service, entity, WOType, VisitType);
        ...
        private static void CreateServiceTaskFromDatabase(IOrganizationService service, Entity entity, EntityReference WorkOrderType, EntityReference VisitType)
        {

            //Retrieve a collection of standard related to the institute type.
            EntityCollection standardList = GetRelatedStandards(service, WorkOrderType, VisitType);
        ...
        private static EntityCollection GetRelatedStandards(IOrganizationService service, EntityReference WorkOrderType, EntityReference VisitType)
        {
